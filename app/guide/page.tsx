...
const faqItems = [
    {
        ...
        a: 'Deepchox runs a **Claude × GPT dual stack**. **OpenAI GPT** powers desk agents (CEO, CFO, PM, CMO, Scout) with role-specific prompts. **Anthropic Claude** runs in parallel on **staff sync** alongside GPT so both model families contribute to merged desk briefs. The **Dexo Intelligence Room** adds a dedicated analysis pass across your venture fields. Routing is automatic — you never pick a provider.',
    },
    {
        q: 'What is Dexo and how is it different from the desk agents?',
        a: '**Dexo** is an ambient intelligence room, not a desk. While desk agents answer domain questions on demand, Dexo reads your entire venture record and produces a **cross-functional analysis** covering strategy gaps, product risks, financial flags, and market signals in one pass. It speaks results aloud in a **Jarvis-style voice** and surfaces prioritised next actions.',
    },
    {
        q: 'Can I talk to Dexo while it is still analysing?',
        a: 'Yes. Dexo uses **non-blocking analysis** — the message bar and voice input are active the moment you enter the room. You can ask follow-up questions or speak a prompt before the first report finishes. The analysis runs in the background and the conversation thread updates when it completes.',
    },
    {
        q: 'How do I interrupt Dexo while it is speaking?',
        a: 'Tap the **microphone button** or speak at any point — Dexo cancels the current speech, registers your interrupt in the conversation thread, and immediately processes your input. You can also tap the **Mute** button to silence the voice while the text report remains on screen.',
    },
    {
        q: 'How is the virtual office meant to work for a solo founder?',
        a: 'You operate as the single decision-maker. Deepchox gives you **desks** where **AI roles act as teammates** (strategy, product, finance, market, GTM, and more): each produces outputs in one venture record so context never splits across tools. **Dexo** sits above the desks as an ambient layer that synthesises all of it.',
    },
    {
    ...
    },
    {
        ...
        a: 'Complete **venture onboarding** so intent and scope exist. Then open the **dashboard** and move between desks as your week demands; run **AI staff sync** when you want the model stack to refresh intel into your venture. Open **Dexo** whenever you want a full cross-functional read of where the venture stands.',
    },
];
            ...
            <div className="mx-auto flex max-w-6xl gap-10 px-5 py-12 sm:px-8 lg:gap-14 lg:py-16">
                ...
                <section id="guide-loop" className="scroll-mt-24 mt-14 border-t border-zinc-800/90 pt-12">
                    ...
                    <ol className="space-y-6 border-l border-zinc-800 pl-6">
                        {[
                            ...
                            {
                                title: 'Run Dexo for a full cross-functional read',
                                body: 'Open the Dexo room from the floating orb or nav. Tap Analyse — Dexo reads every venture field and speaks a structured briefing aloud. Interrupt it at any point to ask a follow-up; it picks up the thread without restarting the analysis.',
                            },
                            {
                ...
                <section id="guide-dexo" className="scroll-mt-24 mt-14 border-t border-zinc-800/90 pt-12">
                    <div className="mb-7 flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-semibold tracking-tight text-white">Dexo Intelligence Room</h2>
                    </div>
                    <ul className="space-y-4 text-[14px] leading-relaxed text-zinc-500">
                        <li>
                            <span className="font-medium text-zinc-300">Canvas sphere orb:</span> a live 60 fps particle sphere renders at the centre of the room. While Dexo is speaking, the sphere pulses and shifts colour in sync with the voice — three overlapping sine-wave frequencies drive organic motion, not looping CSS keyframes.
                        </li>
                        <li>
                        ...
                        <li>
                            <span className="font-medium text-zinc-300">Jarvis-style interruptible voice:</span> Dexo reads its report aloud. Tap the mic or speak at any moment — the current utterance cancels, the interrupt is logged in the conversation, and your input is processed immediately.
                        </li>
                        <li>
                ...
                <section id="guide-orb" className="scroll-mt-24 mt-14 border-t border-zinc-800/90 pt-12">
                    <div className="mb-7 flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-semibold tracking-tight text-white">Floating Dexo orb</h2>
                    </div>
                    <ul className="space-y-4 text-[14px] leading-relaxed text-zinc-500">
                        <li>
                            <span className="font-medium text-zinc-300">Persistent entry point:</span> the animated orb floats at the bottom-right of every screen. Tap it to enter the Dexo room instantly — no nav required.
                        </li>
                        <li>
                            <span className="font-medium text-zinc-300">Voice greeting:</span> on first tap, Dexo speaks an introduction. On subsequent taps it acknowledges your return. The orb remembers across sessions so it never repeats the full intro.
                        </li>
                        <li>
                ...
                <section id="guide-ai" className="scroll-mt-24 mt-14 border-t border-zinc-800/90 pt-12">
                    ...
                    <div className="rounded-2xl border border-zinc-800/90 bg-zinc-950/40 px-5 py-5 sm:px-6 sm:py-6">
                        <p className="text-[14px] leading-[1.65] text-zinc-400">
                            ...
                            <strong className="font-medium text-zinc-300">Dexo</strong> adds a full-record analysis pass. You never choose a model in the UI — routing is automatic and follows your backend configuration.
                        </p>
                    </div>
                </section>
