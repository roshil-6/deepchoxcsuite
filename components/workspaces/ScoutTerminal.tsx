...
export function ScoutTerminal() {
    ...
    return (
        <DeskShell
            eyebrow="CSO · Competitive map + threat level"
            title="Chief Strategy Officer"
            description="Landscape of players and assessed risk to our position. Monitor signals in the feed, then capture conclusions and competitor notes in the brief—shared context for strategy and product."
            tabs={
                <>
