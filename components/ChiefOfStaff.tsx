...
export function ChiefOfStaff() {
    ...
    return (
        <div className="flex flex-col h-full bg-zinc-950/80 backdrop-blur-2xl border-r border-zinc-800/50 z-20 relative font-sans shadow-2xl">
            {/* Header */}
            <div className="p-6 border-b border-zinc-800/50 flex items-center gap-4 bg-zinc-900/20 backdrop-blur-xl sticky top-0 z-10">
            ...
            {/* Input */}
            <div className="p-6 border-t border-zinc-900/50 bg-zinc-950/50 backdrop-blur-xl">
                <div className="relative bg-zinc-900/40 backdrop-blur-md border border-zinc-800 rounded-2xl focus-within:border-indigo-500/50 focus-within:ring-1 focus-within:ring-indigo-500/20 transition-all overflow-hidden shadow-inner group">
                    <input
                        type="text"
                        value={inputValue}
