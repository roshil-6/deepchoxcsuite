...
export function ChiefOfStaff() {
    ...
    return (
        <div className="flex flex-col h-full bg-[#141416] border-r border-zinc-800/50 z-20 relative font-sans shadow-2xl">
            {/* Header */}
            <div className="p-6 border-b border-zinc-800/50 flex items-center gap-4 bg-[#141416] sticky top-0 z-10">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-4 sm:p-5">
                {messages.map((msg) => (
                    <div key={msg.id} className={`flex flex-col gap-1.5 animate-in fade-in slide-in-from-bottom-2 duration-300 ${msg.role === 'user' ? 'items-end' : 'items-start'}`}>
                        ...
                        {/* Delegation Card */}
                        {msg.delegation && (
                            <div className="ml-2 mt-2 p-4 bg-[#141416] rounded-2xl border border-zinc-700/50 w-[300px] animate-in zoom-in-95 duration-500 shadow-2xl relative overflow-hidden group">
            ...
            {/* Input */}
            <div className="p-6 border-t border-zinc-900/50 bg-[#141416]">
                <div className="relative bg-[#141416] border border-zinc-800 rounded-2xl focus-within:border-indigo-500/50 focus-within:ring-1 focus-within:ring-indigo-500/20 transition-all overflow-hidden shadow-inner group">
                    <input
                        type="text"
                        value={inputValue}
