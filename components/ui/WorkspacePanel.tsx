...
export function WorkspacePanel({
    ...
    /**
     * When true, this panel fills the shell height and does not scroll as a whole.
     * The room (e.g. Personal Assistant) owns internal scrolling so the composer stays pinned.
     */
    ...
    return (
        <motion.div
            ...
            className={`relative flex min-h-0 min-w-0 flex-1 flex-col bg-[var(--bg)] ${
                fillViewport
                    ? 'overflow-hidden'
