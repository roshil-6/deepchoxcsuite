            ...
            <div className="relative flex min-h-0 flex-1 overflow-hidden">
                ...
                <div className="flex min-h-0 min-w-0 flex-1 overflow-hidden lg:gap-5 lg:px-5 lg:pb-5 lg:pt-4">
                    ...
                    <WorkspacePanel
                        ...
                        fillViewport={['dexo', 'personal_assistant', 'reports', 'intelligence_diary', 'wargame', 'vc_gauntlet', 'suite_intelligence', 'ceo', 'pm', 'accountant', 'scout', 'cmo'].includes(activeRoom)}
                        roomKey={activeRoom}
                    >
                        <motion.div
                            key={activeRoom}
                            ...
                            className={
                                ['dexo', 'personal_assistant', 'reports', 'intelligence_diary', 'wargame', 'vc_gauntlet', 'suite_intelligence', 'ceo', 'pm', 'accountant', 'scout', 'cmo'].includes(activeRoom)
