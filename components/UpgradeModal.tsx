...
import { X, Check, Brain, Target, Network } from 'lucide-react';
...
const PRO_FEATURES = [
    ...
    },
    {
        ...
        desc: 'Full adversarial simulation with competitor counter-moves, board stress-test, and downloadable reports.',
    },
    {
        icon: Network,
                            ...
                            <div className="inline-flex items-center rounded-full border border-zinc-800 p-1">
                                <button
                                    ...
                                    className={`rounded-full px-5 py-1.5 text-[12px] font-medium transition-all ${
                                        !isYearly ? 'bg-zinc-700 text-white' : 'text-zinc-500 hover:text-zinc-300'
                                    }`}
                                >
                                    Monthly
                                </button>
                                ...
                                >
                                    Yearly
                                    <span className="rounded-sm bg-white/10 px-1.5 py-0.5 text-[9px] font-bold uppercase text-zinc-300">
                                        –17%
                                    </span>
                                </button>
                            </div>
