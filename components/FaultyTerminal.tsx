...
/**
 * FaultyTerminal — WebGL retro terminal digit-field shader background.
 * Ported to TypeScript / React + ogl.
 * SSR-safe: all browser APIs are accessed inside useEffect.
 */
...
export function FaultyTerminal({
    ...
    useEffect(() => {
        ...
        // Re-mount when these change (primitive values only)
        pause,
        timeScale,
        scale,
        digitSize,
        ...
        pageLoadAnimation,
        brightness,
        // arrays / objects excluded intentionally — they'd cause re-mount on every render
        // tintVec is stable because useMemo only changes when `tint` string changes
        tintVec,
        handleMouseMove,
    ]);
