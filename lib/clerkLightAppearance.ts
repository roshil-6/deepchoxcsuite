...
export const clerkLightAppearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButton:
      'bg-white border border-zinc-200 text-zinc-900 hover:bg-zinc-50 hover:border-zinc-300 justify-center gap-3 min-h-[3rem] rounded-xl shadow-[0_1px_2px_rgba(0,0,0,0.06)] transition-colors',
    socialButtonsBlockButtonText: 'text-[15px] font-semibold text-zinc-800',
    socialButtonsProviderIcon: 'size-[22px] shrink-0',
    dividerRow: 'my-2',
